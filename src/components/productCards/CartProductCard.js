        ...
        <div className="bg-neon1-light-2000 hover:bg-neon1-light-900 transform transition hover:scale-102 mx-2 my-3 px-3 py-1 flex flex-wrap flex-row rounded-md">
            ...
            <div className="flex w-full py-1">
                ...
                <div className="flex space-x-3 justify-around flex-grow px-8 space-x-4">
                    <h3 className="flex-grow bg-blue-300 px-3 py-0 text-center rounded-lg font-bold text-lg" >{selectedCount}</h3>
                    <button onClick={() => setSelectedCount(selectedCount - 1)} className="bg-red-400 transition transform hover:scale-110 px-2 py-0 rounded-full" ><i className="fa fa-minus font-bold text-xl"></i></button>
                    <button onClick={() => setSelectedCount(selectedCount + 1)} className="bg-green-500 transition transform hover:scale-110 px-2 py-0 rounded-full" ><i className="fa fa-plus font-bold text-xl"></i></button>
